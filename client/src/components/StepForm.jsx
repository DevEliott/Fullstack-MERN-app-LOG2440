...
export default function StepForm({ step, onChange }) {
  ...
  return (
    <fieldset className='form-control'>
      ...
      <input type='text' name='description' onChange={(event) => handleChange(event)} required />
      ...
      <input type='file' name='img' accept='image/*' ref={imgRef} onChange={(event) => handleChange(event)} required />
    </fieldset>
  );
}
